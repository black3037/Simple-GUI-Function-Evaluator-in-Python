...
class Form(QtGui.QWidget) :
    def __init__(self):
        ...
        # Selection Box for various functions
        self.function_select.addItem("Sin", 'np.sin')
        self.function_select.addItem("Cos", 'np.cos')
        self.function_select.addItem("x^3", 'x**3')
        
        # User inputted x values
        ...
        # adds all the various widgets to the UI
